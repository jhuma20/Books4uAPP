...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a href="/course" className="font-serif">Buy</a>
      </li>
      <li>
        <a  href="/contact" className="font-serif">Contact</a>
      </li>
      <li>
        <a  className="font-serif">About</a>
      </li>
    </>
  );
  return (
      ...
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
        ...
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className=" font-serif text-2xl font-bold cursor-pointer ">Books4U</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              <a className="btn font-serif bg-purple-700 hover:bg-purple-800 duration-300"
